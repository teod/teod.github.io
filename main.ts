...
;(function () {
  if (mobileCheck()) {
    window.alert(
      'In order to get the best experience, you have to open this website on a computer. Using this website on a mobile phone may lack certain functionalities.',
    )
  }
  ...
  const commandsMapToAction = {
    ...
    about: () => writeFromResume('basics.summary'),
